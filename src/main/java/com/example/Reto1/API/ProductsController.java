...
public class ProductsController {
    ...
    public static ArrayList<Product> products = new ArrayList<Product>(Arrays.asList(
        new Product(1, "Brugal", 13.79,"https://s1.dia.es/medias/h1c/h29/10339760504862.jpg"),
        new Product(2, "Nordes", 24.49,"https://s1.dia.es/medias/had/h6a/10322545311774.jpg")
